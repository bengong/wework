...
//		}
		...
		return post(String.format("/checkin/getcheckindata?access_token=%s", access_token), data);
	}
...
//		}
		...
		return post(String.format("/checkin/getcheckinoption?access_token=%s", access_token), data);
	}
}
